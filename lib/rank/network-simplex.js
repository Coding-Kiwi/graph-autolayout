...
import preorder from '../graphlib/alg/preorder';
import postorder from '../graphlib/alg/postorder';

import feasibleTree from './feasible-tree.js'
import { slack, longestPath } from "./util.js";
...
function enterEdge(t, g, edge) {
    ...
    var candidates = _.filter(g.edges(), edge => {
